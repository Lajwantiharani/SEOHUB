export function CtaBand() {
  return (
    <section className="py-12 md:py-16">
      <div className="relative mx-auto w-full max-w-[1080px] overflow-hidden rounded-[2.1rem] bg-[#040404] px-5 py-12 text-white sm:px-8 md:px-12 md:py-14 lg:px-16 lg:py-[4rem]">
        ...
        <div className="relative mx-auto flex max-w-[920px] flex-col items-center text-center">
          ...
          <form className="mt-8 flex w-full max-w-[680px] flex-col items-center gap-4 sm:max-w-[680px] sm:flex-row sm:justify-center" action="#">
